...
* **0. A library is not a luxury but one of the necessities of life**
  * [libemilenfc.so](./libemilenfc.so): C dynamic library containing all the functions
  listed below:
    * `int _putchar(char c);`
    * `int _islower(int c);`
    * `int _isalpha(int c);`
  ...
  * [emilenfc.h](./emilenfc.h): Header file containing the prototypes of all functions
  included in `emilenfc.so`.
